...
void minimum(int grades[STUDENTS][EXAMS], int pupols, int tests);
void maximum(int grades[STUDENTS][EXAMS], int pupils, int tests);
void average(int grades[STUDENTS][EXAMS], int pupils, int tests);
void printArray(int grades[STUDENTS][EXAMS], int pupils, int tests);
void printMenu(void);
...
void minimum(int grades[STUDENTS][EXAMS], int pupils, int tests)
{
	int i, j;
	int lowGrade = 100;
...
{
	printf("\n\tEnter a choice:\n"
		"\t	0	Print the arra of grades\n"
		"\t	1	Find the minimum grades\n"
		"\t	2	Find the manimum grades\n"
